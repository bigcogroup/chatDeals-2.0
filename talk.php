            ...
            if ($result->num_rows > 0) {
                ...
                for ($i = 0; $row = $result->fetch_assoc(); $i++) {
                    ...
                    if ($product_id !== 0) {
                        ...
                        echo '<span class="user btn btn-light" data-receiver="' . $receiverIds[$i] . '">';
                        ...
                        echo '      <button class="accordion-button btn btn-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">';
                        echo '        <span class="user accordion-button" data-receiver="' . $receiverIds[$i] . '">User ' . $row["username"] . '</span>';
                        echo '      </button>';
                        echo '    </h2>';
